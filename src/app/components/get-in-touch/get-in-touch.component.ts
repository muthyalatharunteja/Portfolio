...
export class GetInTouchComponent {
  ...
  contactInfo = [
    { 
      icon: 'email', 
      label: 'Email', 
      value: 'muthyalatharunteja@gmail.com', // Replace with your actual email
      link: 'mailto:muthyalatharunteja@gmail.com' 
    },
    { 
      icon: 'location_on', 
      label: 'Location', 
  ...
  connectLinks = [
    { 
      icon: 'linkedin-in', 
      label: 'LinkedIn', 
      url: 'https://www.linkedin.com/in/muthyalatharunteja/',
    ...
    { 
      icon: 'merge', 
      label: 'GitHub', 
      url: 'https://github.com/muthyalatharunteja',
      // Unified gradient for all buttons
      bgColor: 'bg-gradient-to-r from-indigo-600 via-violet-600 to-fuchsia-600 hover:brightness-110 dark:from-cyan-500 dark:via-sky-500 dark:to-emerald-500'
    },
    { 
      icon: 'mail', 
      label: 'Email', 
      url: 'mailto:muthyalatharunteja@gmail.com', 
      // Unified gradient for all buttons
      bgColor: 'bg-gradient-to-r from-indigo-600 via-violet-600 to-fuchsia-600 hover:brightness-110 dark:from-cyan-500 dark:via-sky-500 dark:to-emerald-500' 
    }
  ];
